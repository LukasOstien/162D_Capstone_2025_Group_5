...
#define StateflowBlock_IN_ACC_Mode     ((uint8_T)1U)
#define StateflowBlock_IN_Acceleration ((uint8_T)2U)
...
void StateflowBlock_step(void)
{
  ...
  if (StateflowBlock_DW.is_active_c3_StateflowBlock == 0U) {
    ...
    /* Outport: '<Root>/ServoA_Sweeping_Enable_Bool' */
    StateflowBlock_Y.ServoA_Sweeping_Enable_Bool = 0.0;
    ...
    if (StateflowBlock_U.on_button_in > 0.0) {
      ...
      /* Outport: '<Root>/ServoA_Sweeping_Enable_Bool' */
      StateflowBlock_Y.ServoA_Sweeping_Enable_Bool = 1.0;
    } else {
      StateflowBlock_DW.speed = 0.0;
    ...
    switch (StateflowBlock_DW.is_ON) {
     case StateflowBlock_IN_ACC_Mode:
      if ((StateflowBlock_U.UltrasoundDistanceA > 450.0) ||
          StateflowBlock_U.pause_button_in) {
        ...
        /* Outport: '<Root>/state' */
        StateflowBlock_Y.state = 6.0;

        /* Outport: '<Root>/KeepDistanceA_Enable_Bool' */
        StateflowBlock_Y.KeepDistanceA_Enable_Bool = 1.0;

        /* Outport: '<Root>/DistanceA_command' */
        StateflowBlock_Y.DistanceA_command = 200.0;
      }
      break;
     ...
     default:
      ...
      if (StateflowBlock_U.decel_button_in > 0.0) {
        ...
        /* Outport: '<Root>/KeepDistanceA_Enable_Bool' */
        StateflowBlock_Y.KeepDistanceA_Enable_Bool = 0.0;
      } else if (StateflowBlock_U.UltrasoundDistanceA < 350.0) {
        StateflowBlock_DW.is_ON = StateflowBlock_IN_ACC_Mode;
