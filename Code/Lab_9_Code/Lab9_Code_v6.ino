...
#define DC_MotorB_Encoder_PinA  A15
...
// PCINT22  DON'T CHANGE THIS ONE unless you set your pin change interrupt yourself 
...
*/
  ...
  Serial.print(DesiredRoverGlobalDirection*180/3.14159);
