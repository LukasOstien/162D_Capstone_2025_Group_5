###########################################################################
## Makefile generated for component 'StateflowBlock'. 
## 
## Makefile     : StateflowBlock.mk
## Generated on : Mon May 05 09:30:04 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/StateflowBlock
...
PRODUCT_NAME              = StateflowBlock
MAKEFILE                  = StateflowBlock.mk
MATLAB_ROOT               = /Applications/MATLAB_R2024b.app
MATLAB_BIN                = /Applications/MATLAB_R2024b.app/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/maci64
START_DIR                 = /Users/anliliu/Downloads/LukasOstien/purepursuit/Lab10_Code_v5/src
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/StateflowBlock
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/StateflowBlock_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=StateflowBlock -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/StateflowBlock_ert_rtw/StateflowBlock.c $(START_DIR)/StateflowBlock_ert_rtw/StateflowBlock_data.c
...
OBJS = StateflowBlock.o StateflowBlock_data.o
...
%.o : $(START_DIR)/StateflowBlock_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/StateflowBlock_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/StateflowBlock_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/StateflowBlock_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/StateflowBlock_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
StateflowBlock.o : $(START_DIR)/StateflowBlock_ert_rtw/StateflowBlock.c
	$(CC) $(CFLAGS) -o "$@" "$<"


StateflowBlock_data.o : $(START_DIR)/StateflowBlock_ert_rtw/StateflowBlock_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
