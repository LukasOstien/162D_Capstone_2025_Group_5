###########################################################################
## Makefile generated for component 'ControlLoop'. 
## 
## Makefile     : ControlLoop.mk
## Generated on : Tue Apr 22 17:54:08 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ControlLoop
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ControlLoop
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/ControlLoop_ert_rtw -I$(START_DIR)/LukasOstien/Lab10_Code_v5/src -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=ControlLoop -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/ControlLoop_ert_rtw/ControlLoop.c $(START_DIR)/ControlLoop_ert_rtw/ControlLoop_data.c
...
OBJS = ControlLoop.o ControlLoop_data.o
...
%.o : $(START_DIR)/ControlLoop_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/ControlLoop_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/ControlLoop_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/ControlLoop_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/ControlLoop_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ControlLoop.o : $(START_DIR)/ControlLoop_ert_rtw/ControlLoop.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ControlLoop_data.o : $(START_DIR)/ControlLoop_ert_rtw/ControlLoop_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
